...
<head>
	...
	<script type="text/javascript" src="<?php DOCUMENT_URL ?>assets/js/uikit.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="<?php DOCUMENT_URL ?>assets/css/uikit.css">
...
<body>
	...
	<div id="wrapper" class="container">
		...
		<header id="header" class="jumbotron" style="">
			<div class="container">
				<img id="img-logo-primary" src="assets/images/sao-jose-logo.png" class="img-responsive col-xs-7 col-xl-7">
